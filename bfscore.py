...
if __name__ == "__main__":
    ...
    score = bfscore('data/gt_1.png', 'data/crf_1.png', 2)    # Same classes
    # score = bfscore('data/gt_0.png', 'data/pred_0.png', 2)    # Different classes
    print("BFSCORE:", score)
    print("Per image score:", np.nanmean(score))
